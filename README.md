...
- 업데이트를 시작한 화면과 관계없이 우측 하단 상태 팝업 표시
- 확인·다운로드 퍼센트·용량·속도·설치 준비·오류 상태 안내
- 다운로드 완료 후 팝업에서 바로 설치 및 재시작
- 실패 시 재시도와 최신 설치기 직접 다운로드 제공
- 설치 목표 버전을 보존하고 새 버전 재실행 후 업데이트 완료 안내
